...
//		model.addAttribute("top12Posts", top12PostsByCommentCount); //댓글 모델에 담음
	...
	@GetMapping("/fullSearch/{boardType}/{searchBoardId}")
	public String searchDetailBoard(@PathVariable String boardType, @PathVariable Long searchBoardId, Model model){
